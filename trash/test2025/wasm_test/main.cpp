  ...
  EM_ASM({
    ...
    g_draw=()=>
    {
      ...
      for(let i=0;i<g_VBN;i++){
        ...
        qDev.carr[i*4+0]=HEAPU8[g_VB+i*6*4+3*4+0]/255;
        qDev.carr[i*4+1]=HEAPU8[g_VB+i*6*4+3*4+1]/255;
        qDev.carr[i*4+2]=HEAPU8[g_VB+i*6*4+3*4+2]/255;
        qDev.carr[i*4+3]=HEAPU8[g_VB+i*6*4+3*4+3]/255;
